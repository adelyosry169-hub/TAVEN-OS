...
st.markdown("---")
st.caption(
    "ملحوظة مهمة: الملفات المرفوعة هنا بتتحلل لحظيًا في الصفحة بس، ومش بتتحفظ "
    "بشكل دائم على السيرفر. لو عايز الملف يتحول لشيت دائم في TAVEN.xlsx يتحدث "
    "منه، قولّي وهنضيف زرار 'حفظ كشيت دائم'."
)
